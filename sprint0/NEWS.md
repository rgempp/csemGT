...
* Two vignettes: tutorial introduction and replication of the four published examples.
* Note: this package is the first of a planned series. The broader csemR package (in development) will integrate csem_gt() with additional estimator families.
