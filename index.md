...
`csemGT` will be able to migrate to `csemR` via a simple
[`library()`](https://rdrr.io/r/base/library.html) change; the function
signature and output object are identical.
